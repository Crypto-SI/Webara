...
type ProfileQuoteDetailClientProps = {
  quoteId: string;
};

export function ProfileQuoteDetailClient({ quoteId }: ProfileQuoteDetailClientProps) {
  ...
  const handleRequestCall = () => {
    if (!quoteId) return;
    console.log('Requesting a call for quote:', quoteId);
    toast({
  ...
  const handleRejectOffer = () => {
    if (!quoteId) return;
    console.log('Offer rejected for quote:', quoteId);
    toast({
    ...
    quote && (
      <>
        <CardHeader>
          ...
          <CardDescription>
            Review your quote details and proposed collaboration models below.
          </CardDescription>
        </CardHeader>
